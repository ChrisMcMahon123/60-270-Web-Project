        ...
        <div class="flex-sm-fill m-2">
            <ul class="list-group">
                ...
                <li id="login-form" class="list-group-item">
                    <form name="upload-textbook" action="../php/upload-script.php" onsubmit="return validateUploadForm()" method="post">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="cover" id="cover-upload">
                                <label class="custom-file-label" for="cover-upload">Select File</label>
                            </div>
                        </div>
